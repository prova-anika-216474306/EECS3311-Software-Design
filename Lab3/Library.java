...
class Library {
	...
	// TODO post-condition: if this method returns true, the newBook should be in
	// old holdings (i.e., before executing this method)
	// @ ensures

	 /*@ ensures \result == true;
	 @ ensures \old(holdings.contains(newBook));
	 @*/

	// TODO post-condition: if this method returns false, the newBook should not be
	// in old holdings
	// @ ensures
	...
	// @ ensures 
	/*@ ensures \result == false;
	@ ensures (\forall Book e ;
	@ holdings.indexOf(e) == \old(holdings.indexOf(e)));
	@*/
